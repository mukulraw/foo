...
public class ProfileEditCall {
    ...
    public ProfileEditCall(Activity activity,String email, String name,String interest,String first_name,String last_name, String profile_pic,String profession,String dob) {
