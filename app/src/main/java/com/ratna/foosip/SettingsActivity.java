...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.app.DatePickerDialog datePickerDialog = new android.app.DatePickerDialog(SettingsActivity.this,
    ...
    private void setView() {
        ...
        txt_email.setText(savedParameter.getEMAIL(SettingsActivity.this));
        txt_user_name.setText(savedParameter.getUSERNAME(SettingsActivity.this));

//        Toast.makeText(SettingsActivity.this,base_64,Toast.LENGTH_SHORT).show();
