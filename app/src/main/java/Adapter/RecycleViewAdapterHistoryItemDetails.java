 ...
 */
public class RecycleViewAdapterHistoryItemDetails extends RecyclerView.Adapter<RecycleViewAdapterHistoryItemDetails.ViewHolder>
    ...
    public RecycleViewAdapterHistoryItemDetails(Activity context,ArrayList<HashMap<String, String>> items) {
    ...
    @Override
    public RecycleViewAdapterHistoryItemDetails.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final RecycleViewAdapterHistoryItemDetails.ViewHolder holder, final int position) {
